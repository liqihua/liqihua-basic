...
public class TestPersonApiController extends BaseController {
    ...
    public WebResult test1(Integer page,
                           Integer pageSize){
        Page<TestPersonEntity> p = new Page<TestPersonEntity>(page,pageSize);
        /*List<TestPersonEntity> list = testPersonDao.testPage(p);
        p.setRecords(list);*/
        return buildSuccessInfo(testPersonDao.testPage(p));
    }
