...
import com.liqihua.modules.sys.entity.SysPermEntity;
import com.liqihua.modules.sys.entity.SysPermMenuEntity;
import com.liqihua.modules.sys.entity.SysRolePermEntity;
import com.liqihua.modules.sys.entity.vo.SysMenuVO;
import com.liqihua.modules.sys.entity.vo.SysPermMenuVO;
import com.liqihua.modules.sys.entity.vo.SysPermVO;
    ...
    public WebResult listGroupByMenuId(){
        ...
        if(pmList != null && pmList.size() > 0) {
            ...
            if(menuIdList != null && menuIdList.size() > 0) {
                List<SysMenuEntity> menuList = sysMenuService.list(new QueryWrapper<SysMenuEntity>().in("id",menuIdList).eq("hide",false).orderByAsc("rank_num"));
